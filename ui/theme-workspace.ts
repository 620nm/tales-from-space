...
import { edge, none } from "./theme-tokens";

export const workspaceRules = [
  rule("computer-screen", {
    position: "relative", display: "block", width: "100%", height: "100%", minHeight: 0,
    padding: 0, gap: 0, backgroundColor: "#101b23", border: none, borderRadius: 0, overflow: "auto",
  }),
  ...
  rule("computer-off", { backgroundColor: "#000000", justifyContent: "end" }),
  rule("workspace-frame", {
    backgroundColor: "#15262fcc", border: edge("#8da5ae80"), borderRadius: 2,
    padding: 8, gap: 6, minHeight: 0,
  }),
  rule("workspace-information", { flexShrink: 0, gap: 3, maxHeight: "30%", overflow: "auto" }),
  ...
  rule("workspace-drive", { height: "100%", overflow: "auto", minWidth: 0 }),
  rule("workspace-drive-title", { fontSize: 17, fontWeight: "bold" }),
  rule("workspace-stem", { flexGrow: 0, flexShrink: 0, height: 28, minHeight: 28 }),
  ...
  rule("desktop-controls", { flexShrink: 0, gap: 6, flexWrap: "wrap" }),
];
