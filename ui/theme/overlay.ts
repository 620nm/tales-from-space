...
export const overlayRules: UiStyleRule[] = [
  ...
  rule("hover-card", {
    ...
    fontFamily: "sans", fontSize: 13, lineHeight: 1.35, color: ink, textShadow: sunk, userSelect: "none", pointerEvents: "none",
  }),
  ...
  rule("hover-title", { minWidth: 0, fontSize: 15, fontWeight: 700, whiteSpace: "normal" }),
  ...
  rule("hover-group", { color: dim, fontSize: 11, marginTop: 4 }),
  ...
  rule("hover-requirement", { color: dim, fontSize: 11, whiteSpace: "normal" }),
  ...
  rule("hover-key", {
    fontFamily: "sans", fontSize: 11, lineHeight: 1.4, minWidth: 0, whiteSpace: "normal",
  ...
  // second one costs.
  rule("hover-key-tight", { fontSize: 11, minWidth: 20, paddingLeft: 3, paddingRight: 3 }),
