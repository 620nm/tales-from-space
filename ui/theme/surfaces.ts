...
export const surfaceRules: UiStyleRule[] = [
  ...
  rule("inspect-title", { flexGrow: 1, minWidth: 0, fontSize: 12, fontWeight: 700, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }),
  rule("inspect-body", { gap: 3, maxHeight: 60, overflow: "hidden" }),
  rule("inspect-full", { alignSelf: "start", marginTop: 6, fontFamily: "mono", fontSize: 10, color: dim, backgroundColor: "transparent", border: edge(titleLine) }),
  ...
  rule("inspect-stack", { maxHeight: "72%", overflowY: "auto", gap: 7, alignItems: "start" }),
  ...
  rule("composer-entry", {
    height: 22, minHeight: 22, flexGrow: 1, flexShrink: 1, fontSize: 10, color: ink,
